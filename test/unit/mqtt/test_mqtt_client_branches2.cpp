...
namespace
{
	...
	// iteration budget is exhausted (see test_mqtt_client.cpp). Generous budget:
	// a GitHub-hosted fallback runner (e.g. a Dependabot PR, which cannot reach
	// the self-hosted fleet) has far less headroom than the self-hosted big
	// runner this was tuned against.
	template <class Pred>
