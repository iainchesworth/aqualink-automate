...
namespace AqualinkAutomate::ErrorCodes
{
	...
	std::string Message_ErrorCategory::message(int ev) const
	{
		...
		case Message_ErrorCodes::Error_CannotFindGenerator:
			return "Message_ErrorCodes::Error_CannotFindGenerator";
		...
		case Message_ErrorCodes::Error_GeneratorFailed:
			return "Message_ErrorCodes::Error_GeneratorFailed";

		case Message_ErrorCodes::Error_FailedToSerialize:
			return "Message_ErrorCodes::Error_FailedToSerialize";

		case Message_ErrorCodes::Error_FailedToDeserialize:
			return "Message_ErrorCodes::Error_FailedToDeserialize";
