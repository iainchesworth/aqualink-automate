...
namespace AqualinkAutomate::Devices
{
	...
	KeypadDevice::KeypadDevice(boost::asio::io_context& io_context, const Devices::JandyDeviceType& device_id) :
		KeypadDevice(io_context, device_id, JandyControllerOperatingModes::MonitorOnly)
	{
	}

	KeypadDevice::KeypadDevice(boost::asio::io_context& io_context, const Devices::JandyDeviceType& device_id, JandyControllerOperatingModes op_mode) :
		JandyController(io_context, device_id, KEYPAD_TIMEOUT_DURATION, op_mode)
	{
	...
	KeypadDevice::KeypadDevice(boost::asio::io_context& io_context, const Devices::JandyDeviceType& device_id, JandyControllerOperatingModes op_mode, Config::JandyConfig& config) :
		KeypadDevice(io_context, device_id, op_mode)
	{
		InjectConfig(config);
	}
