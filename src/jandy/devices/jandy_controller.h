...
namespace AqualinkAutomate::Devices
{
	...
	{
	public:
		JandyController(boost::asio::io_context& io_context, std::shared_ptr<Devices::JandyDeviceType> device_id, std::chrono::seconds timeout_in_seconds, Kernel::DataHub& config);
